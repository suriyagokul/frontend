        ...
        <Navbar.Toggle aria-controls="basic-navbar-nav" />
          <Navbar.Collapse
            ...
            <Nav className="ml-auto" >
                  <Link className="text-gray-600"  style={{ textDecoration: 'none'}} to="/services">Services</Link>
                  <Link className="text-gray-600"  style={{ textDecoration: 'none'}} to="/about">About</Link>
                  <Link className="text-gray-600"  style={{ textDecoration: 'none'}}  to="/testimonials">Testimonials</Link>
            </Nav>
