        ...
        <Navbar.Toggle aria-controls="basic-navbar-nav" />
          <Navbar.Collapse
            ...
            <Nav className="ml-auto" >
                  <Link className="text-lg text-white bg-sky-500 hover:bg-sky-700 mr-2 no-underline rounded-full p-4" to="/services">Services</Link>
                  <Link className="text-lg text-white bg-sky-500 hover:bg-sky-700 mr-2 no-underline rounded-full p-4" to="/about">About</Link>
                  <Link className="text-lg text-white bg-sky-500 hover:bg-sky-700 no-underline rounded-full p-4"  to="/testimonials">Testimonials</Link>
            </Nav>
